# Students Performance Pipeline

## Overview

This project builds and evaluates multiple **regression models** to predict a students' math score out of 100. The implementation focuses on **linear models**, **regularisation techniques**, and **polynomial feature expansion**, all organised using **scikit-learn pipelines** for clarity, reproducibility, and proper preprocessing.

The goal is to compare how different regression strategies perform on the classic **Students Performance dataset**, especially in terms of bias–variance trade‑off and generalisation.
...
The dataset consists of marks of students on 3 different tests, their gender and their racial/ethnic group, containing both numerical and categorical features.
...
* **Supervised Learning**
* **Regression Task**
* **Continuous Target Variable (`math score`)**
...
```
StudentsPerformance_Pipeline.py
README.md
StudentsPerformance.xls
```
...
```
python StudentsPerformance_Pipeline.py
```
