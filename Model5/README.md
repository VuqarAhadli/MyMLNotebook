...
* **Source:** Kaggle — *Glass Identification Data Set*
* **Author:** UC Irvine Machine Learning Repository
* **Link:** [https://www.kaggle.com/datasets/uciml/glass](https://www.kaggle.com/datasets/uciml/glass)

The dataset contains chemical composition measurements of glass samples along with a target variable (**Type**) representing the glass category.

---

### Objective

To build a **multiclass classification model** that predicts the type of glass using its chemical properties, while handling feature scaling, class imbalance, and evaluating model performance in a reproducible manner.

---

### Exploratory Data Analysis (EDA)

* **Correlation heatmap** used to inspect relationships between chemical features (`RI, Na, Mg, Al, Si, K, Ca, Ba, Fe`).
* **Class distribution plots** to visualise sample imbalance across glass types.
* **Boxplots/violin plots** to inspect differences in chemical composition among classes.
...
* Standardisation (`StandardScaler`) to normalize chemical measurements.

Class imbalance is preserved via stratified train-test splitting.
...
* **Variants:** Multinomial, One-vs-Rest, One-vs-One
* **Max iterations:** 500

All models are fully pipeline-driven, ensuring reproducibility.
...
Metrics are chosen to balance overall correctness with sensitivity to minority glass types.

---

### Key Characteristics

* Fully pipeline-driven (scaling and model in one flow)
* Leakage-safe and reproducible
* Supports multiclass ROC–AUC visualisation
* Suitable for experimentation, hyperparameter tuning, and benchmarking

---

### Use Case

This model serves as a **baseline classifier for glass type identification**, suitable for:

* Educational ML projects
* Comparative model benchmarking
* Feature importance and chemical analysis studies
